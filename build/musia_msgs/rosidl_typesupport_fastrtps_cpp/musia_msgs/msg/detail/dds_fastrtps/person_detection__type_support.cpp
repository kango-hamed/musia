...
#include "musia_msgs/msg/detail/person_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const musia_msgs::msg::PersonDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  musia_msgs::msg::PersonDetection & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = musia_msgs::msg::PersonDetection;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_musia_msgs
max_serialized_size_key_PersonDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const musia_msgs::msg::PersonDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<musia_msgs::msg::PersonDetection *>(
    untyped_ros_message);
...
static size_t _PersonDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PersonDetection(full_bounded, is_plain, 0);
...
{
  return &musia_msgs::msg::typesupport_fastrtps_cpp::_PersonDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, musia_msgs, msg, PersonDetection)() {
  return &musia_msgs::msg::typesupport_fastrtps_cpp::_PersonDetection__handle;
}
