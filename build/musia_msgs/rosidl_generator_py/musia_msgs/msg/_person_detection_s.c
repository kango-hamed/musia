...
bool musia_msgs__msg__person_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("musia_msgs.msg._person_detection.PersonDetection", full_classname_dest, 48) == 0);
  }
  musia_msgs__msg__PersonDetection * ros_message = _ros_message;
  {  // header
...
PyObject * musia_msgs__msg__person_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("musia_msgs.msg._person_detection");
