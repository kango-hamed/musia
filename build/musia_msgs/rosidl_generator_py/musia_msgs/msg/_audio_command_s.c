...
bool musia_msgs__msg__audio_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("musia_msgs.msg._audio_command.AudioCommand", full_classname_dest, 42) == 0);
  }
  musia_msgs__msg__AudioCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AudioCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("musia_msgs.msg._audio_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioCommand");
