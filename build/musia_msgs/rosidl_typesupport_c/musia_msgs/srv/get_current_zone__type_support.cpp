...
static const _GetCurrentZone_Request_type_support_symbol_names_t _GetCurrentZone_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musia_msgs, srv, GetCurrentZone_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, musia_msgs, srv, GetCurrentZone_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, musia_msgs, srv, GetCurrentZone_Request)() {
  return &::musia_msgs::srv::rosidl_typesupport_c::GetCurrentZone_Request_message_type_support_handle;
}
...
static const _GetCurrentZone_Response_type_support_symbol_names_t _GetCurrentZone_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musia_msgs, srv, GetCurrentZone_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, musia_msgs, srv, GetCurrentZone_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, musia_msgs, srv, GetCurrentZone_Response)() {
  return &::musia_msgs::srv::rosidl_typesupport_c::GetCurrentZone_Response_message_type_support_handle;
}
...
static const _GetCurrentZone_Event_type_support_symbol_names_t _GetCurrentZone_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musia_msgs, srv, GetCurrentZone_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, musia_msgs, srv, GetCurrentZone_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, musia_msgs, srv, GetCurrentZone_Event)() {
  return &::musia_msgs::srv::rosidl_typesupport_c::GetCurrentZone_Event_message_type_support_handle;
}
...
static const _GetCurrentZone_type_support_symbol_names_t _GetCurrentZone_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musia_msgs, srv, GetCurrentZone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, musia_msgs, srv, GetCurrentZone)),
  }
};
...
static const rosidl_service_type_support_t GetCurrentZone_service_type_support_handle = {
  ...
  &GetCurrentZone_Request_message_type_support_handle,
  &GetCurrentZone_Response_message_type_support_handle,
  &GetCurrentZone_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, musia_msgs, srv, GetCurrentZone)() {
  return &::musia_msgs::srv::rosidl_typesupport_c::GetCurrentZone_service_type_support_handle;
}
